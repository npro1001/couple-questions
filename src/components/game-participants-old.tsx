...
export default function GameParticipantsOld() {
  ...
  if (loading) {
    return (
      <div className="flex justify-center items-center space-x-[-1rem]">
  ...
  return (
    ...
    >
      {participants.map((participant, index) => (
        <div
          key={participant.id}
          className={`absolute z-10 flex justify-center items-center transition-transform duration-1000 ease-in-out w-full ${
